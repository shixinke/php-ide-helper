...
class swoole_http_server extends swoole_server
{
    ...
    /**
     * 
     *创建一个swoole http server对象
     * @example 
     * @param string $host 创建一个swoole http server对象
     * @param int $port 创建一个swoole http server对象
     * @param int $mode 创建一个swoole http server对象
     * @param int $sock_type 创建一个swoole http server对象
     * @return 
     */
