...
/**
*一个兼容Redis服务器端协议的Server框架，可基于此框架实现Redis协议的服务器程序
*/
class swoole_redis_server extends swoole_server
{
    ...
    */
     ...
     *设置Redis命令字的处理器
     * @example 
     * @param string $command 设置Redis命令字的处理器
     * @param callable $callback 设置Redis命令字的处理器
     ...
     *格式化命令响应数据
     * @example 
     * @param int $type 格式化命令响应数据
     * @param mixed $value 格式化命令响应数据
     * @return 
     */
     ...
     *注册Server的事件回调函数
     * @example 
     * @param string $event_name 注册Server的事件回调函数
     * @param callable $callback 注册Server的事件回调函数
     * @return bool
     */
     ...
     *tick定时器，可以自定义回调函数
     * @example 
     * @param int $ms tick定时器，可以自定义回调函数
     * @param callable $callback tick定时器，可以自定义回调函数
     * @return 
     */
