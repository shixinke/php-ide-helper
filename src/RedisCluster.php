<?php
/**
 * Helper autocomplete for php redis extension(RedisCluster)
 * @author shixinke<ishixinke@qq.com>
 * @link https://github.com/shixinke/phpstorm-for-php-framework
 *
 *
 */
class RedisCluster
{
     ...
     * @param mixed $clusterName ��Ⱥ����(һ����php.ini�ж���)
     * @param array $nodes �ڵ��б�
     *
     * @example $redis = new RedisCluster(null, array('127.0.0.1:6379', '127.0.0.1:6380'));
     */
    public function __construct($clusterName = null, Array $nodes) {}
    ...
    *  (int/string), or an array. Arrays that are returned can also contain other arrays, if that's how it was set up in
     ...
     *
     * @return string: master, slave, or sentinel
     ...
     *
     * @param string keyword which can be: "channels", "numsub", or "numpat" argument: Optional, variant. For the "channels"
     * @param string|array|null subcommand, you can pass a string pattern. For "numsub" an array of channel names.
     *                          The callback will get four arguments ($redis, $pattern, $channel, $message)
     ...
     * </pre>
     */
    public function pubSub($keyword, $subcommand = null){}
